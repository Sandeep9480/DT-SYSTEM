  ...
  return (
    <div className="w-full relative bg-white overflow-hidden flex flex-col items-start justify-start leading-[normal] tracking-[normal] text-left text-[1.5rem] text-white font-archivo">
      ...
      >
        ...
        >
          <motion.i
            className="w-[30.5rem] relative leading-[2.5rem] inline-block max-w-full z-[2] mq450:text-[1.188rem] mq450:leading-[2rem]"
          ...
          >
            <motion.i
              className="relative leading-[2.5rem] z-[2] mq450:text-[1.188rem] mq450:leading-[2rem]"
              variants={textVariants}
            >
            ...
            <div className="flex flex-col items-start justify-start max-w-full text-[2rem]">
              <motion.h2
                className="m-0 relative text-inherit leading-[3.125rem] inline-block italic font-normal font-inherit max-w-full z-[2] mq800:text-[1.625rem] mq800:leading-[2.5rem] mq450:text-[1.188rem] mq450:leading-[1.875rem]"
                variants={textVariants}
              >
                At DT SYSTEMS we deliver
              </motion.h2>
              <motion.h2
                className="m-0 relative text-inherit leading-[3.125rem] italic font-semibold font-inherit z-[3] mq800:text-[1.625rem] mq800:leading-[2.5rem] mq450:text-[1.188rem] mq450:leading-[1.875rem]"
                variants={textVariants}
              >
